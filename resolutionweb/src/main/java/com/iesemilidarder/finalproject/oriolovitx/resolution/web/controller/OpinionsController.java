...
public class OpinionsController {
    ...
    public List<Opinions> getAllOpinions(){ return opinionsService.getAllOpinions();
    }

    /*Opinions per id*/
    @RequestMapping("/opinions/{id}")
    public Opinions getOpinions(@PathVariable String id){ return opinionsService.getOpinionsById(id);
    }

    /*Afegeix opinions*/
    @RequestMapping(method = RequestMethod.POST, value = "/opinions")
    public void addOpinions(@RequestBody Opinions opinions){ opinionsService.addOpinions(opinions);
    }
    ...
    public void updateOpinions(@RequestBody Opinions opinions, @PathVariable String id){
        opinionsService.updateOpinions(opinions,id);
    }

    /*Elimina opinions*/
    @RequestMapping(method = RequestMethod.DELETE, value = "/opinions/{id}")
    public void deleteOpinions(@PathVariable String id){
